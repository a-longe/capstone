...
-irrarional numbers are numbers that cannot be repersented by a fraction (for example pi is one of the most famous irrational number and cannot be repersented by a fraction though 22/7is the most popular APROXIMATION)
