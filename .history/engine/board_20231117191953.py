...
from my_utils import row_index_to_legend, row_legend_to_index, column_index_to_letter
...
class Board:
    ...
    def get_fen(self) -> str:
        ...
        for piece in self.piece_list:
            dict_key = row_legend_to_index[int(piece.position[const.LOCATION_ROW])]
        ...
        for row_index in range(const.NUM_ROWS):
            ...
            if row_index in rows.keys():
                ...
                row_list = [0 for not_accessed in range(const.LEN_ROW)]
