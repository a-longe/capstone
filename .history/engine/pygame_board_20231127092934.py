...
PieceDisplay = (pg.Surface, tuple[int, int], bool)
...
def add_piece_to_buffer(buffer:list, piece_surface:pg.Surface, coords:tuple[int, int], is_dragging):
    buffer.append((piece_surface, coords, is_dragging))
