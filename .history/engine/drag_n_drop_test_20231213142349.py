            ...
            for player in Board.get_players():
                if player.click:
                    ...
                    if player.board.mouse_inside_bounds() and True:
                        ...
                        collisions = [piece_2 for piece_2 in player.rect.collideobjectsall(player.board.get_players()) if piece_2.rect.collidepoint(pg.mouse.get_pos()) 
                                                                                                                        and piece_2.is_white == player.is_white]
                        print(collisions)
                        if len(collisions) == 1:
