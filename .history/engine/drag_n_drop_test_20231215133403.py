...
class Board:
    ...
    def __init__(self, positions):
        ...
        for piece_data in positions:
            ...
            map_key = sum(board_rel_cords[0] / SQUARE_SIZE,
                          board_rel_cords[1] / SQUARE_SIZE)
            print(map_key)
            self.piece_map.append(Piece(self, piece_data[RECT_DATA],
                                    piece_data[GLYPH]))
...
if __name__ == "__main__":
    ...
    pg.init()
    MyBoard = Board(fen_to_pieces('8/8/8/8/8/8/8/8 w - - 0 1'))
