...
def get_snap_cords(x, y) -> Cord:
    return (math.floor(x / SQUARE_SIZE) * SQUARE_SIZE, math.floor(y / SQUARE_SIZE) * SQUARE_SIZE)
...
class Player:
    ...
    def snap_to_square(self) -> None:
        ...
        player_snap_cords = get_snap_cords(*player_cords)
        self.rect.topleft = player_snap_cords
