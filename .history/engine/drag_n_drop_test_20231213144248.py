                ...
                if player.click:
                    ...
                    if player.board.mouse_inside_bounds() and True:
                        ...
                        if not colliding_piece:
                            ...
                            print(player.board.get_players(), player.board.set_players(player.board.get_players().pop(player.board.get_players().index(player_to_del))))
                            player.board.set_players(player.board.get_players().remove(player_to_del))                            
                            player.snap_to_square()
                        else:
