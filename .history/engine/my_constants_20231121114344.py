...
STARTING_BOARD = Board(STARTING_PIECE_LIST, STARTING_EN_PASSANT_TARGET, STARTING_CASTLING_RIGHTS, STARTING_IS_WHITE, STARTING_HALFMOVE_CLOCK, STARTING_FULLMOVE_CLOCK)
