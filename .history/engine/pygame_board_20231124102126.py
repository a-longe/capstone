...
w_tile_img = image.load(path.join(IMAGE_DIR, 'wtile.png'))
b_tile_img = image.load(path.join(IMAGE_DIR, 'btile.png'))

def create_checkerboard() -> Surface:
    checkerboard = display.set_mode((WINDOW_WIDTH, WINDOW_HEIGHT))
